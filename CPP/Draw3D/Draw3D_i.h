 ...
 */
/* Compiler settings for Draw3D.idl:
...
#ifndef __Draw3D_i_h__
#define __Draw3D_i_h__
...
EXTERN_C const IID IID_IPreview;
    ...
    MIDL_INTERFACE("013013b2-2d1e-48fb-88c2-0a55d08f6aa2")
...
EXTERN_C const IID IID_IThumbnail;
    ...
    MIDL_INTERFACE("01302af1-e6e4-43e8-b928-e7f5ad1c4669")
...
#ifndef __Draw3DLib_LIBRARY_DEFINED__
#define __Draw3DLib_LIBRARY_DEFINED__

/* library Draw3DLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_Draw3DLib;

EXTERN_C const CLSID CLSID_Preview;

#ifdef __cplusplus

class DECLSPEC_UUID("01303c3d-639f-4020-bf52-c77013f6495a")
Preview;
#endif
...
class DECLSPEC_UUID("0130e987-df3c-4819-9525-810ccfc43d29")
Thumbnail;
#endif
#endif /* __Draw3DLib_LIBRARY_DEFINED__ */
